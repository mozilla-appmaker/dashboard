...
(function() {
  ...
  Repo = (function() {
    ...
    Repo.prototype.issues = function(page, cb) {
      console.log("in modified issues");
      console.log("/repos/" + this.name + "/issues?page=" + page);
      return this.client.get("/repos/" + this.name + "/issues?page=" + page, function(err, s, b) {
        console.log("ERR", err, "S", s, "cb", cb);
        return {
          issues: function(cb) {
            console.log(b);
            if (err) {
